...
class MediumFees extends StatefulWidget {
  MediumFees({super.key});

  @override
  _MediumFeesState createState() => _MediumFeesState();
}

class _MediumFeesState extends State<MediumFees> {
