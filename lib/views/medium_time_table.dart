...
class MediumTimeTable extends StatefulWidget {
  MediumTimeTable({super.key});

  @override
  _MediumTimeTableState createState() => _MediumTimeTableState();
}

class _MediumTimeTableState extends State<MediumTimeTable> {
